...
export default function App() {
  ...
  const handleBooking = async (teeTime: TeeTime) => {
    ...
    setLoading(true);
    try {
      const result = await handleClubhouseBooking(
        teeTime,
        selectedCourse,
        playerCount,
      );
        ...
        <div className="p-12 flex flex-col gap-8 h-[220px] border-b border-white/5 relative overflow-hidden group">
          ...
          <div className="flex items-center gap-6">
            <div className="w-16 h-16 bg-gradient-to-br from-[#30C476] to-[#30C476]/60 rounded-[22px] flex items-center justify-center shrink-0 shadow-[0_0_50px_rgba(48,196,118,0.35)] rotate-3 group-hover:rotate-0 transition-transform duration-700">
              <span className="font-serif italic text-black text-4xl tracking-tighter">
                F
              </span>
            </div>
            {sidebarOpen && (
              <div className="animate-in fade-in slide-in-from-left-6 duration-1000">
                <h1 className="font-serif italic text-4xl tracking-tight leading-none text-[#30C476]">
                  Fluff
                </h1>
                <p className="text-[10px] font-tech text-[#4A4A5A] uppercase tracking-[0.6em] mt-3">
                  The 19th Hole
                </p>
              </div>
            )}
          ...
          {sidebarOpen && (
            <div className="flex items-center gap-3 bg-white/[0.03] p-3 rounded-2xl border border-white/5">
              ...
              <div className="flex flex-col">
                <span className="text-[9px] font-tech text-white/40 uppercase tracking-widest leading-none">
                  Heritage Status
                </span>
                <span className="text-[10px] font-bold text-yellow-500/90 uppercase mt-1 tracking-tighter text-nowrap">
                  Augusta Circle • 8x Patron
                </span>
              </div>
            </div>
          )}
          ...
          {sidebarOpen ? (
            <div className="flex flex-col gap-5 animate-in fade-in duration-1000">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-tech uppercase tracking-widest text-[#4A4A5A]">
                  Locker Room
                </span>
                <span className="text-[10px] font-mono text-[#30C476] bg-[#30C476]/10 px-3 py-1 rounded-full uppercase border border-[#30C476]/20 font-bold">
                  DT-08
                </span>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-3 h-3 rounded-full bg-[#30C476] animate-pulse shadow-[0_0_20px_rgba(48,196,118,0.7)]" />
                <span className="text-[12px] font-tech uppercase tracking-[0.3em] text-white/90 font-bold">
                  Secure Uplink
                </span>
              </div>
            </div>
        ...
        <header className="h-[100px] md:h-[130px] border-b border-white/5 flex items-center justify-between px-8 md:px-20 bg-[#0A0A0A]/80 backdrop-blur-3xl z-40 relative">
          ...
          <div className="flex items-center gap-6 md:gap-12">
            <button
              ...
              className="hidden md:flex p-5 hover:bg-white/5 rounded-[22px] transition-all text-white/20 hover:text-[#30C476] border border-transparent hover:border-white/5 active:scale-95 shadow-2xl"
            >
              {sidebarOpen ? <X size={28} /> : <Menu size={28} />}
            </button>
            <div className="md:hidden flex flex-col">
              <h1 className="font-serif italic text-2xl text-[#30C476] leading-none">
                Fluff
              </h1>
              <span className="text-[7px] font-tech text-[#4A4A5A] uppercase tracking-[0.4em] mt-1">
                19TH HOLE
              </span>
            </div>
          ...
          <div className="flex items-center gap-6 md:gap-12 group cursor-pointer">
            <div className="text-right hidden sm:block">
              <p className="text-[11px] font-tech text-[#4A4A5A] uppercase tracking-[0.6em] mb-2 leading-none font-bold">
                Elite Patron
              </p>
              <p className="text-lg font-bold uppercase tracking-tight group-hover:text-[#30C476] transition-colors duration-700 leading-none">
                {user?.displayName || "DREW T ERNST"}
              </p>
            </div>
          ...
          {activeTab === "weather" ? (
            ...
            <div className="animate-in fade-in slide-in-from-bottom-12 duration-1000">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12 md:mb-16 border-b border-white/5 pb-12">
                <div>
                  <h3 className="font-display text-8xl md:text-9xl tracking-tighter mb-4 uppercase leading-none">
                    The Ledger
                  </h3>
                  <p className="text-[12px] font-tech text-[#4A4A5A] uppercase tracking-[0.8em]">
                    Championship Round Logs
                  </p>
                </div>
                <button className="bg-white text-black px-12 py-5 rounded-[30px] font-black uppercase text-xs hover:bg-[#30C476] transition-all hover:scale-105 active:scale-95 shadow-3xl w-full md:w-auto">
                  Log Final Score
                </button>
              </div>
              <Scorecard
            ...
            <div className="relative h-[550px] md:h-[750px] rounded-[60px] md:rounded-[100px] overflow-hidden border border-white/10 shadow-[0_80px_160px_rgba(0,0,0,1)] group ring-1 ring-white/5">
              ...
              <div className="absolute bottom-16 left-8 md:bottom-32 md:left-24 max-w-5xl animate-in fade-in slide-in-from-bottom-16 duration-[2000ms]">
                ...
                <h2 className="font-display text-8xl md:text-[18rem] mb-8 md:mb-12 leading-[0.7] md:leading-[0.6] tracking-tighter opacity-95 uppercase text-glow">
                  PEBBLE BEACH
                </h2>
                <p className="text-[#4A4A5A] mb-12 md:mb-20 font-medium text-xl md:text-4xl leading-snug md:leading-tight max-w-3xl border-l-2 border-[#30C476]/20 pl-8 md:pl-16 italic">
                  "The ultimate meeting of land and sea."
                </p>
                <div className="flex flex-col sm:flex-row gap-6 md:gap-12">
                  <button
                    onClick={() => setActiveTab("search")}
                    className="bg-white text-black px-12 md:px-24 py-6 md:py-10 rounded-[35px] md:rounded-[50px] font-black uppercase text-sm md:text-lg hover:bg-[#30C476] transition-all hover:scale-105 active:scale-95 shadow-[0_50px_100px_rgba(0,0,0,0.7)] flex items-center justify-center gap-6 md:gap-8 group/btn"
                  >
                    Secure Tee Time{" "}
                    <ChevronRight
                      size={28}
                      className="group-hover/btn:translate-x-4 transition-transform duration-700"
                    />
                  </button>
                </div>
              </div>
            ...
            !selectedCourse && (
              <section className="animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-700">
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-20 border-b border-white/5 pb-16 md:pb-20">
                  <h3 className="font-display text-8xl md:text-9xl tracking-tighter mb-6 uppercase leading-none">
                    The Links
                  </h3>
                  <div className="flex gap-6 items-center">
                    <div className="bg-white/[0.01] border border-white/5 p-5 md:p-6 rounded-[40px] shadow-4xl ring-1 ring-white/5 flex items-center gap-6">
                      <input
                        ...
                        className="accent-[#30C476] w-48 md:w-80 h-2 bg-white/10 rounded-full appearance-none cursor-pointer"
                      />
                      <span className="text-[14px] md:text-[16px] font-mono text-[#30C476] font-black">
                        {searchRadius}MI
                      </span>
                    </div>
                  </div>
...
const CourseCard = ({ course, onClick }: any) => (
  ...
  >
    ...
    <div className="p-10 md:p-12">
      <h3 className="text-4xl md:text-5xl font-display font-bold text-white mb-3 tracking-tight group-hover:text-[#30C476] transition-colors">
        {course.name}
      </h3>
      <div className="flex items-center gap-2 text-[#4A4A5A] mb-8">
        <MapPin size={16} className="flex-shrink-0 text-[#30C476]" />
        <span className="text-sm font-tech uppercase tracking-widest">
          {course.city}, {course.state}
        </span>
        <span className="text-xs font-mono text-[#30C476]">
          • {course.distance} mi
        </span>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8 pb-8 border-b border-white/5">
        <div className="text-center px-2 py-1">
          <div className="text-3xl font-display font-bold text-[#30C476] leading-none">
            18
          </div>
          <div className="text-[9px] text-[#4A4A5A] font-bold mt-2 tracking-widest uppercase">
            Holes
          </div>
        </div>
      ...
      <button className="w-full bg-[#30C476] hover:bg-white text-black font-black py-5 px-6 rounded-2xl transition-all duration-500 flex items-center justify-center gap-3 group/btn uppercase text-xs tracking-widest shadow-xl hover:shadow-[#30C476]/20 hover:scale-[1.02] active:scale-95">
        ...
        <ArrowUpRight
          size={16}
          className="opacity-0 group-hover/btn:opacity-100 transition-all duration-500 translate-y-1 group-hover/btn:translate-y-0"
        />
      </button>
    </div>
  </div>
...
const TeeTimeView = ({ course, teeTimes, onBack, onBook, loading }: any) => (
  <div className="animate-in fade-in duration-1000 slide-in-from-right-20">
    <button
      onClick={onBack}
      className="mb-24 text-[16px] font-tech text-[#30C476] uppercase tracking-[1em] flex items-center gap-10 hover:translate-x-[-20px] transition-all group"
    >
      <div className="bg-[#30C476]/10 p-6 rounded-[40px] group-hover:bg-[#30C476]/20 transition-colors border border-[#30C476]/20 shadow-4xl">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center gap-6 mt-12">
          <div className="flex items-center gap-3 bg-white/5 px-6 py-3 rounded-2xl border border-white/5">
            ...
            <span className="font-tech text-sm uppercase tracking-widest">
              {course.city}, {course.state}
            </span>
          </div>
          <div className="flex items-center gap-3 bg-white/5 px-6 py-3 rounded-2xl border border-white/5">
    ...
    <div className="space-y-16 max-w-[1600px] pb-80">
      {teeTimes.map((t: any) => (
        <div
          key={t.id}
          className="group bg-white/[0.01] backdrop-blur-[200px] border border-white/5 p-20 rounded-[100px] flex flex-col lg:flex-row items-center justify-between hover:border-[#30C476]/50 transition-all duration-1000 shadow-2xl relative overflow-hidden"
        >
          <div className="flex flex-col sm:flex-row items-center gap-40 relative z-10">
            <div className="text-center">
              <div className="font-display text-[14rem] tracking-tighter text-[#30C476] group-hover:text-white transition-colors leading-none">
                {t.time}
              </div>
            </div>
            <div className="grid grid-cols-2 gap-x-32 gap-y-12">
              <div className="space-y-6">
                <div className="flex items-center gap-8 text-4xl font-mono text-white/60 font-black">
                  <Users size={40} className="text-[#30C476]" />
                  <span>{t.availableSlots} Players</span>
                </div>
              </div>
              <div className="space-y-6">
                <div className="flex items-center gap-8 text-4xl font-mono text-[#30C476] font-black">
                  <DollarSign size={40} />
                  <span>${t.price}</span>
                </div>
              </div>
          ...
          <button
            onClick={() => onBook(t)}
            className="bg-[#30C476] text-black px-32 py-12 rounded-[60px] font-black uppercase text-xl hover:bg-white hover:scale-105 active:scale-95 transition-all shadow-2xl flex items-center gap-10 group/btn relative z-10"
          >
            Confirm Round{" "}
            <ChevronRight
              size={40}
              className="group-hover/btn:translate-x-6 transition-transform duration-1000"
            />
          </button>
        </div>
      ))}
  ...
  return (
    <div className="glass-surface rounded-[80px] p-20 border border-white/10 relative overflow-hidden shadow-[0_80px_160px_rgba(0,0,0,0.9)] ring-1 ring-white/5">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-16 px-4 md:px-0">
        <div className="flex flex-col">
          <span className="text-[10px] font-tech text-[#30C476] uppercase tracking-[0.8em] mb-4">
            Tactical Course Layout
          </span>
          <h4 className="text-6xl font-display uppercase tracking-tight text-white leading-none text-glow">
            {name}
          </h4>
        </div>
        <div className="flex gap-12 bg-white/[0.02] p-8 rounded-[40px] border border-white/5 w-full sm:w-auto">
          <div className="text-center flex-1 px-8">
            <p className="text-[9px] font-tech text-[#4A4A5A] uppercase tracking-widest mb-2">
              Total Par
            </p>
            <p className="text-7xl font-display text-[#30C476] font-black tracking-tighter">
              {teeBox?.par_total || 72}
            </p>
          </div>
          <div className="text-center border-l border-white/10 flex-1 px-8">
            ...
            <p className="text-7xl font-display text-white font-black tracking-tighter">
              {teeBox?.total_yards || "---"}
            </p>
          </div>
        </div>
      ...
      <div className="overflow-x-auto custom-scrollbar pb-12">
        <div className="inline-flex gap-6 min-w-full">
          {holes.map((hole: any, i: number) => (
            <div
              key={i}
              className="w-40 shrink-0 bg-white/[0.01] border border-white/5 rounded-[40px] p-10 text-center hover:bg-[#30C476]/[0.03] transition-all duration-700 group cursor-pointer hover:shadow-2xl"
            >
              <p className="text-[11px] font-tech text-[#4A4A5A] uppercase tracking-widest mb-6 font-bold">
                Hole {i + 1}
              </p>
              <div className="space-y-4">
                <div>
                  <p className="text-xs font-mono text-white/20 uppercase tracking-tighter">
                    Par
                  </p>
                  <p className="text-5xl font-display text-white font-black group-hover:text-[#30C476] transition-colors leading-none">
                    {hole.par}
                  </p>
                </div>
                <div className="pt-4 border-t border-white/5">
                  <p className="text-[10px] font-mono text-[#30C476] font-bold">
                    {hole.yardage} YDS
                  </p>
                  <p className="text-[9px] font-mono text-[#4A4A5A] mt-1">
                    HCP {hole.handicap}
                  </p>
                </div>
              </div>
...
const GPSReconView = ({ location }: any) => (
  <div className="animate-in fade-in slide-in-from-bottom-12 duration-1000 h-full flex flex-col">
    <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-16 border-b border-white/5 pb-12">
      <div>
        <h3 className="font-display text-9xl tracking-tighter mb-6 uppercase leading-none text-glow">
          GPS Recon
        </h3>
        <div className="flex items-center gap-10">
          <p className="text-[13px] font-tech text-[#4A4A5A] uppercase tracking-[1em] font-bold">
            Satellite Tactical Display
          </p>
          <div className="h-2.5 w-2.5 rounded-full bg-[#30C476]/30 shadow-[0_0_20px_rgba(48,196,118,0.5)]" />
          <span className="text-[12px] font-mono text-[#30C476] uppercase tracking-[0.3em] font-black">
            Augusta Grade Precision
          </span>
        </div>
      </div>
    </div>
    <div className="flex-1 glass-surface rounded-[80px] border border-white/10 relative overflow-hidden shadow-4xl ring-1 ring-white/5 min-h-[600px] group">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center p-20 text-center">
        ...
        <h4 className="font-display text-6xl md:text-8xl uppercase tracking-tighter mb-8">
        ...
        <p className="text-xl md:text-2xl font-tech text-white/40 uppercase tracking-[0.5em] max-w-2xl mx-auto leading-relaxed italic">
          Coordinates Locked: {location?.latitude.toFixed(4) || "SCANNING"} /{" "}
          {location?.longitude.toFixed(4) || "SCANNING"}
        </p>
      </div>
...
const ClubCard = ({ label, model, yardage }: any) => (
  <div className="glass-surface rounded-[40px] p-12 border border-white/5 hover:border-[#30C476]/30 transition-all duration-700 group">
    <p className="text-[11px] font-tech text-[#4A4A5A] uppercase tracking-[0.5em] mb-4 font-bold">
      {label}
    </p>
    <p className="text-3xl font-display text-white font-black tracking-tight mb-6 group-hover:text-[#30C476] transition-colors">
      {model}
    </p>
    <div className="space-y-2 border-t border-white/5 pt-8">
      <p className="text-4xl font-display text-[#30C476] uppercase tracking-widest font-black">
        {yardage} YDS
      </p>
    </div>
  </div>
...
const MobileNavItem = ({ icon, active, onClick }: any) => (
  <button
    ...
    className={cn(
      ...
      active ? "text-[#30C476] bg-[#30C476]/10" : "text-[#4A4A5A]",
    )}
  >
    {active && (
      <motion.div
        layoutId="activeIndicatorMobile"
        className="absolute -top-10 left-1/2 -translate-x-1/2 w-8 h-[2px] rounded-full bg-[#30C476] shadow-[0_0_20px_rgba(48,196,118,1)]"
...
const NavItem = ({ icon, label, active, expanded, onClick }: any) => (
  <button
    ...
    className={cn(
      ...
      active
        ? "bg-[#30C476]/10 text-[#30C476] border border-[#30C476]/20 shadow-[0_0_80px_rgba(48,196,118,0.25)]"
        : "text-[#4A4A5A] hover:text-white hover:bg-white/[0.03] border border-transparent",
    )}
  >
    {active && (
      <div className="absolute left-0 w-3 h-14 bg-[#30C476] rounded-r-full shadow-[10px_0_50px_rgba(48,196,118,1)]" />
    )}
    <div
      className={cn(
        "shrink-0 transition-all duration-700",
        active
          ? "text-[#30C476] scale-125 rotate-6"
          : "group-hover:text-white group-hover:translate-x-3",
      )}
    >
      {icon}
    </div>
    {expanded && (
      <span className="text-[17px] font-black uppercase tracking-[0.4em] overflow-hidden whitespace-nowrap">
        {label}
      </span>
    )}
  </button>
...
const CaddieIntelView = ({ location }: any) => (
  <div className="animate-in fade-in slide-in-from-bottom-12 duration-1000">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
      <IntelCard
        icon={<Wind size={32} className="text-[#30C476]" />}
        label="Atmospheric Drift"
        value="12 MPH"
        subValue="Direction: NE"
        trend="GUSTS UP TO 18 MPH"
      />
      <IntelCard
        icon={<Waves size={32} className="text-[#30C476]" />}
        label="Surface Integrity"
        value="STIMP 13.5"
        subValue="Firmness: Tournament Ready"
        trend="MOISTURE: 4%"
      />
      <IntelCard
        icon={<Zap size={32} className="text-[#30C476]" />}
        label="Playability Index"
        value="98 / 100"
        subValue="Elite Tier Deployment"
...
const IntelCard = ({ icon, label, value, subValue, trend }: any) => (
  <div className="glass-surface rounded-[60px] p-16 border border-white/5 hover:border-[#30C476]/30 transition-all duration-700 group">
    <div className="w-20 h-20 bg-white/[0.02] rounded-3xl flex items-center justify-center mb-10 group-hover:scale-110 transition-transform border border-white/5 group-hover:bg-[#30C476]/5">
      {icon}
    </div>
    <p className="text-[11px] font-tech text-[#4A4A5A] uppercase tracking-[0.5em] mb-4 font-bold">
      {label}
    </p>
    <p className="text-7xl font-display text-white font-black tracking-tight mb-6 group-hover:text-[#30C476] transition-colors">
      {value}
    </p>
    <div className="space-y-2 border-t border-white/5 pt-8">
      <p className="text-[10px] font-mono text-[#4A4A5A] uppercase font-bold">
        {subValue}
      </p>
      <p className="text-[10px] font-mono text-[#30C476] uppercase font-black">
        {trend}
      </p>
    </div>
  </div>
